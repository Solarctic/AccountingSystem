 ...
 * @author SOL
 */
public class frmPriceDatabase extends frmSuperList {

    /**
     * Creates new form frmGameDatabase
     */
    public frmPriceDatabase(Connection sqlpass){
        super(sqlpass);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPriceDatabase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
